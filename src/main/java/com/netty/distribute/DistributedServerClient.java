...
import com.netty.handler.business.SendMessageHandler;
            ...
            b.group(group).channel(NioSocketChannel.class)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel ch) {
                            ...
                            //后面这段代码可以删除 用于测试
                            ch.pipeline().addLast(ServerCommand.MessageType.SENDMESSAGE.name(), new SendMessageHandler(DistributedServerUtil.getServerAddress()));
